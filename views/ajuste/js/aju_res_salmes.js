...
var listarMesas = function(id_salon,descripcion){
    ...
    .DataTable({
        ...
        "columns":[
            ...
            {"data":null,"render": function ( data, type, row) {
                if(data.forma === 0){
                  return '<div class="bg-success rounded" style="width: 20px; height: 20px; "></div>';
                } else {
                  return '<div class="bg-warning rounded-circle" style="width: 20px; height: 20px;"></div>'
                }
            }},
            ...
            {"data":null,"render": function ( data, type, row ) {
                ...
                return '<div class="text-right"><a href="javascript:void(0)" class="text-info edit" onclick="editarMesa('+data.id_mesa+',\''+data.nro_mesa+'\',\''+data.estado+'\',\''+data.forma+'\');"><i data-feather="edit" class="feather-sm fill-white"></i></a>'
                    +'&nbsp;'+deleteMesasHTML+'</div>';
            }}
...
var editarMesa = function(id_mesa,nro_mesa,estado, forma){
    $(".f").addClass("focused");
    $('#id_mesa').val(id_mesa);
