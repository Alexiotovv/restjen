	                            	...
	                            	<div class="table-responsive">
	                                    <table class="table table-condensed table-hover" width="100%">
	                                        ...
	                                        <tbody>
												...
												<tr>
	                                                <td style="width:50px;">
	                                                	<span class="round round-warning"><i class="ti-pencil-alt"></i></span>
	                                                </td>
	                                                <td>
	                                                    <h5 class="m-t-5 m-b-0">Nombre de Producto en PDF</h5><h6 class="text-muted">Disponible en Factura, Boletas y Notas de ventas.</h6>
	                                                </td>
	                                                <td class="text-right p-r-0" style="vertical-align: middle;">
														<!-- 0 = pro_nom, 1 = pro_pres, 2 = pro_nom - pro_pres -->
														<select class="form-control form-control-sm" name="namePDF" id="namePDF">
  															<option value = "0">Producto</option>
															<option value = "1">Presentación</option>
															<option value = "2">Producto - Presentación</option>
														</select>
	                                                </td>
	                                            </tr>
	                                        </tbody>
