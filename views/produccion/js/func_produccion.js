...
var nropedidosMesa = function(){
	$.ajax({     
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            ...
            // Puedes mostrar un mensaje en la p¨¢gina
            $('#list-pedidos').html('<div class="justify-center" style="height: 100%;"><div class="text-center"><h4 style="color: red;">Ocurri¨® un error al cargar los pedidos.</h4><p>' + errorThrown + '</p></div></div>');
        }
	})
}
        ...
        $.each(data, function(i, item) {
    		...
    		$('#list_pedidos_mesa')
	            .append(
	                ...
	                .append(
	                    $('<td/>')
	                    .html('<h5 class="m-b-0">NÂ° '+item.nro_mesa+'</h5><h6 class="text-muted">'+item.desc_salon+'</h6>')
	                )
	                .append(
	                    $('<td/>')
	                ...
	                .html('<div class="card">'
	                	...
	                	+'<table class="table stylish-table b-t" id="table'+i+'">'
	                		+'<thead class="table-head">'
		                        +'<tr><th width="10%">AtenciÃ³n</th><th width="40%">Cantidad/Producto</th><th width="15%">Tiempo</th><th width="15%">Estado</th><th width="10%">Mozo/Cajero</th><th width="10%" class="text-right">Acci&oacute;n</th></tr>'
		                    +'</thead>'
