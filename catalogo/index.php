          ...
          if(data.length  === 0){
            ...
            $.each(data, function(i, campo) {
              if(campo == false)
              {
                ...
                $.each(campo, function(e, pres){
                  //console.log(pres.presentacion);
                  html_body += '<div class="col-lg-4 menu-item">' +
                    '<a href="../public/images/productos/'+pres.imagen+'" id="miImagen" class="glightbox"><img src="../public/images/productos/'+pres.imagen+'" class="menu-img img-fluid" alt=""></a>' +
                    '<h4>' + pres.presentacion + '</h4>' +
                    '<p class="price">' +
                    'S/. ' + pres.precio +
                    '</p>' +
                    '</div>';
